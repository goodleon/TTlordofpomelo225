...
function CGameFight3pWith3(majiang, _GLOG, _app, tTable, logid, gameid, publicIp) {
...
g_Inherit(require("./CGameCodeFightEnd.js"), CGameFight3pWith3)
 ...
 * 玩家出牌（打牌）
 */
CGameFight3pWith3.prototype.fRecieveMjPut = function(pl, msg, session, next, tTable) {
    var isAutoPut = true;
    if (next) {
    ...
    this.GLog("CGameFight3pWith3-----Table.prototype.MJPut1!!!!!!!!");
    ...
    if (tData.tState == TableState.waitPut && pl.uid == tData.uids[tData.curPlayer]) {
        ...
        if (cdIdx >= 0) {
            ...
            this.GLog("CGameFight3pWith3.js------------>push(cmd,msg) = ");
...
module.exports = CGameFight3pWith3;