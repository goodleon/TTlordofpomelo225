...
function CGameFight2pDoubleCard(majiang, _GLOG, _app, tTable, logid, gameid, publicIp) {
    this.majiang = majiang;
    this.GLog = _GLOG;
    this.app = _app;
    this.GLog("CGameCodeFight2p!!!!!!!!!!");
    this.tTable = tTable;
    this.existCheck = {};
    this.logid = logid;
    this.gameid = gameid;
...
g_Inherit(require("./CGameCodeFight3p.js"), CGameFight2pDoubleCard)
...
module.exports = CGameFight2pDoubleCard;