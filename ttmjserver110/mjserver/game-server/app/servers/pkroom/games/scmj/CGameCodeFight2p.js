...
function CGameCodeFight2p(majiang, _GLOG, _app, tTable, logid, gameid, publicIp) {
...
g_Inherit(require("./CGameCodeFightEnd.js"), CGameCodeFight2p)
...
module.exports = CGameCodeFight2p;