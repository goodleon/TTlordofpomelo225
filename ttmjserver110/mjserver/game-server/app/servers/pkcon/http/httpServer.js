	...
	AddWebHandler("post","",
		{
			...
			CreateVipTable:function(req,res)
			{
				...
				var fakeSession={pkplayer:pkplayer};fakeSession.get=function(key){return this[key]};
			...
			,JoinVipTable:function(req,res)
			{
				...
				var fakeSession={pkplayer:plServer};fakeSession.get=function(key){return this[key]};
