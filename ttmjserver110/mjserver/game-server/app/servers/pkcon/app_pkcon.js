module.exports = function(pomelo,app,SessionRoute,DirectRoute) 
{
   ...
   var ComponentData = require ('./pkconData');app.load (ComponentData,{});
   var LoginData = require ('../login/LoginData');app.load (LoginData,{});
   //app.route('login',SessionRoute( 'login' ) );
   
   var PKPlayer = require ('../pkplayer/pkplayerData');app.load (PKPlayer,{});
