...
*/
    ...
    serverClass.prototype.FindCoinTable = function (msg, next) {
        console.info("--matcherCode--serverClass.prototype.FindCoinTable" + JSON.stringify(msg) + ", uid = " + msg.uid);
    ...
    serverClass.prototype.LeaveCoinTable = function (msg, next) {
        console.info("--matcherCode--serverClass.prototype.LeaveCoinTable" + JSON.stringify(msg) + ", uid = " + msg.uid);
