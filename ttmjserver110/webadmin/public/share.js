...
var gameType={
    ...
    zhuzhouphz:{
        loginImg:"images/zhuzhouphz.png",
        name:"逸趣碰胡会员管理后台",
        agentname:"逸趣碰胡会员代理后台",
        color:"background-color:#F5F5DC",
        addDiamondName:"添加逸趣碰胡元宝",
        rechargeOpen:true,
        wxScanPay:false,
        alipayTextTip:"请在浏览器里面操作充值",
        wxScanPayTextTip:"充值完成后请重新加载页面",
	...
	hnyymj:{
		loginImg:"images/hnyymj.png",
		name:"岳阳麻将会员管理后台",
		agentname:"岳阳麻将会员代理后台",
		color:"background-color:#F5F5DC",
