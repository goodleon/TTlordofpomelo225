__resources__["/playerHandler.js"] = {
    ...
    data: function(exports, require, module, __filename, __dirname) {
        ...
        function applyJoinTeam(params) {
            ...
            if (params.targetTeamId > TeamC.TEAM_ID_NONE && params.targetIsCaptain) {
                pomelo.notify("area.teamHandler.applyJoinTeam", { captainId: params.targetPlayerId, teamId: params.targetTeamId });
            }
        }
        ...
        function inviteJoinTeam(params) {
            ...
            if (params.myTeamId > TeamC.TEAM_ID_NONE && params.myIsCaptain) {
                pomelo.notify("area.teamHandler.inviteJoinTeam", { inviteeId: params.targetPlayerId, teamId: params.myTeamId });
            }
        }
